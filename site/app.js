...
const UA = {
  ...
  h_lead: "Я — Тетяна Чернишова, косметолог із медичною освітою. Працюю зі шкірою через причини: гормони, дефіцити, сон — а не лише через баночки та процедури.",
  h_cta1: "Почати 30 днів — від €10",
  ...
  b_note: '<b>ПОЗНАЧКА ЛІКАРЯ · </b> «в нормі» — а для відновлення замало. Ось причина втоми',
  ...
  ab_eyebrow: "Хто я",
  ab_h2: 'Косметолог, який бачить <em class="acc">глибше шкіри</em>',
  ab_p: "Шкіра — дзеркало всього організму. Як косметолог і лікар-невролог я збираю картину цілком: догляд, гормони, сон, дефіцити — і шукаю причину, а не глушу симптоми.",
  ab_btn: "Про мене",
  ...
  c_trust: "Косметолог · 20 років практики · доктор наук",
  fit_yes_h: "Курс для вас, якщо",
  fit_yes1: "втома не минає після відпочинку",
  fit_yes2: "шкіра й волосся змінилися за останні роки",
  fit_yes3: "лікарі кажуть «все в нормі», а самопочуття — ні",
  fit_no_h: "Не підійде, якщо",
  fit_no1: "чекаєте на ефект без щоденних дій",
  fit_no2: "шукаєте «чарівну» добавку чи ін'єкцію",
  fit_no3: "потрібне лікування гострого захворювання — це до вашого лікаря",
  pay_note: "Оплата WayForPay · доступ прийде в Telegram",
  c_doc_eyebrow: "Хто веде курс", c_doc_h2: "Косметолог із медичною освітою",
  ...
  /* Про Тетяну */
  a_eyebrow: "Про мене",
  a_h1: 'Косметолог, який дивиться <em class="acc">на причини</em>',
  a_p1: "Я — Тетяна Чернишова, косметолог. За плечима — медична освіта лікаря-невролога, докторський ступінь, Інститут біомедицини (Гранада, Іспанія) та 20 років клінічної практики. Живу в Іспанії, працюю онлайн.",
  ...
  a_f1: "Косметолог · медична освіта лікаря-невролога",
  a_f2: "Доктор наук · Інститут біомедицини, Гранада",
  a_f3: "20 років клінічної практики",
  a_f4: "Косметологія · anti-age · жіноче здоров'я 35+ · превентивна медицина за аналізами",
